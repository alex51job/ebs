<%@ Page Title="" Language="C#" MasterPageFile="~/MoKuai_Hunli/Hunli.Master" AutoEventWireup="true" CodeBehind="hlAuditFinance.aspx.cs" Inherits="ebs.MoKuai_Hunli.hlAuditFinance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeaderContent" runat="server">
<script src="hlAuditFinance.js?d=<%=DateTime.Now.ToFileTime() %>" type="text/javascript"></script>
    <style type="text/css">
        .OnlyBottom
        {
            border-left: none;
