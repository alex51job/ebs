<%@ Page Title="" Language="C#" MasterPageFile="~/MoKuai_Hunli/Hunli.Master" AutoEventWireup="true" CodeBehind="HunliAudit.aspx.cs" Inherits="ebs.MoKuai_Hunli.HunliAudit1" %>
                                ...
                                <div class="col-lg-8 col-lg-offset-2">
                                     <table class="table table-condensed table-bordered text-center" width="100%">
                                        <tr>
                                            ...
                                            <th style="text-align: center" runat="Server" id="titleAction">操作</th>
                                        </tr>
                                        <asp:Repeater ID="RepeaterFile" 
                                            onitemcommand="RepeaterFile_ItemCommand" 
                                            onitemdatabound="RepeaterFile_ItemDataBound" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td>
                                                        <a href='<%# Eval("FilePath") %>' target="_blank">
                                                            <%# Eval("FileName") %></a><asp:HiddenField ID="hfFileName" Value=<%# Eval("FileName") %> runat="server" />
                                                    </td>
                                                    <td>
                                                        <%# Eval("CreatedDt", "{0:yyyy-MM-dd}") %>
                                                    </td>
                                                    <td runat="Server" id="tdAction"> <asp:LinkButton ID="lbdel" runat="server"  CommandName="delete" Visible="false" CommandArgument='<%# Eval("ID") %>'>删除</asp:LinkButton></td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </table>
