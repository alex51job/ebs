...
{
    public partial class KehuList : System.Web.UI.Page
    {
        ...
        private List<Customers> DependOnRole(List<Customers> sources)
        {
            ...
            {
                sources = sources.Where(q => q.ZixunDiDian == mengdian).ToList();
            }
            return sources;
        }
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            using (ebsDBData db = new ebsDBData())
            {
                ...
                if (cus.Kefu == "商务销售" && cus.Sales == currentUser.userName && currentUser.roles.Contains("商务"))
                {
                    edit.Visible = true;
                    lbView.Visible = false;
                }
