...
{
    public class LoginCheckerMaster : System.Web.UI.MasterPage
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            //{
            //    tbUsers us = db.tbUsers.First(q => q.ID == 21);
            ...
            //}
            //Session["LoginUserInfo"] = new ComCls.LoginUser{ ID=1, mailAddress="15712593@qq.com", userName="Sys_Admin", DisplayName="Alex", roles="客服"};
           
            if (HttpContext.Current.Session != null && HttpContext.Current.Session["LoginUserInfo"] != null)
            {
