<%@ Page Title="" Language="C#" MasterPageFile="~/MoKuai_admin/admin.Master" AutoEventWireup="true" CodeBehind="CaidanList.aspx.cs" Inherits="ebs.MoKuai_admin.CaidanList" %>
...
<script type="text/javascript">
    $(function () {
        ...
        function () {
            ...
            $('#exampleModal').modal({
                remote: "CaidanEdit.aspx?ts=" + (new Date().getTime())
            });
    ...
    function Edit(obj) {
        var s = $(obj).attr("args");
        $('#exampleModal').modal({
            remote: "CaidanEdit.aspx?id=" + s + "&ts=" + (new Date().getTime())
        });
        $('#exampleModal').modal('show');
    }
...
<div class="col-sm-12 col-md-12 col-lg-12 col-lg-offset-0">
            <div class="panel panel-default">
                <a href="#listUser" class="panel-heading" data-toggle="collapse">菜单列表</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="error-text"><i class="fa fa-warning modal-icon"></i>可能已有使用该菜单的商务/婚礼订单，是否确定继续删除？</p>
      </div>
